...
class NewItemForm(FlaskForm):
    ...
    id = StringField('UGC', default="", validators=[DataRequired()], render_kw={"class": "border border-black rounded-lg text-black px-2 py-1 focus:outline-none w-full text-lg", "autocomplete":"off"})
